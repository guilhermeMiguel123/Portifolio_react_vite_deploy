    ...
    <div className="font-sans bg-gradient-to-r from-purple-900 via-gray-900 to-black text-white">
      ...
      <div className="relative">
        ...
        <section id="about" className="relative z-10 p-8 text-center">
          ...
          <br />
          <h2>
            Olá, sou Guilherme, um estudante de Engenharia de Software com um
            forte interesse em desenvolvimento de software e tecnologia. Estou
            em busca de oportunidades que me permitam adquirir experiência
            prática e aplicar meus conhecimentos acadêmicos em projetos reais.
          </h2>
        </section>
